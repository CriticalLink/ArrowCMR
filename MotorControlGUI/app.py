...
@author: Tom Sharkey
@version 2020-15-10-007
@last-modified 2020-15-10
"""
...
class GUI(AdiWindow):
    ...
    def __init__(self):
        ...
        self.serial_queue = SerialQueue(self, self.dataQ)
        ...
        self.plotter = DataPlotter(self, self.dataQ, self.canvas_frame, self.motor)
